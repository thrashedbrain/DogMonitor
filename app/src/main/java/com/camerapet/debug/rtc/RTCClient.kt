...
class RTCClient(
    ...
    private var videoCapturer: CameraVideoCapturer? = getVideoCapturer(context)
                ...
                .get().addOnSuccessListener {
                    ...
                    for ( dataSnapshot in it) {
                        if (dataSnapshot.contains("type") && dataSnapshot["type"]=="offerCandidate") {
                            ...
                            iceCandidateArray.add(IceCandidate(offerCandidate["sdpMid"].toString(), (offerCandidate["sdpMLineIndex"] as Long).toInt(), offerCandidate["sdp"].toString()))
                        } else if (dataSnapshot.contains("type") && dataSnapshot["type"]=="answerCandidate") {
                            val answerCandidate = dataSnapshot
                            iceCandidateArray.add(IceCandidate(answerCandidate["sdpMid"].toString(), (answerCandidate["sdpMLineIndex"] as Long).toInt(), answerCandidate["sdp"].toString()))
                        }
                    }
